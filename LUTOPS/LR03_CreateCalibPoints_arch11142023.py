...
try:
    ...
    # Production_STREETS_CntyRouteCalib = "C:\\Users\\ryanr\\AppData\\Roaming\\Esri\\ArcGISPro\\Favorites\\NpStreets.sde\\Production.STREETS.CntyRouteCalib"
    arcpy.management.CopyFeatures(in_features=LRS_Calibration,
                                  out_feature_class=NpSTREETS_CntyRouteCalib, config_keyword="",
                                  spatial_grid_1=None, spatial_grid_2=None, spatial_grid_3=None)
    # arcpy.lr.MakeRouteEventLayer(NpSTREETS_LID_routes, "LOCALID", RoadsAMS_Assets_Mileposts, "LOCALID POINT LIDPct", LRS_Calibration, "", "NO_ERROR_FIELD", "NO_ANGLE_FIELD", "NORMAL", "ANGLE", "LEFT", "POINT")
    # print ("Calibration points made")
    # # Process: Copy Features from IRIS Calibration point events
    # arcpy.CopyFeatures_management(LRS_Calibration, NpSTREETS_CntyRouteCalib, "", "0", "0", "0")
