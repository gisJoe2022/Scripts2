...
try:
    ...
    from DataTransfer.modMoveData_3_7 import GISAppendFeatures, GISTruncate,GISmfLyr
  ...
  ## .lyr file name and GISbug feature class name must be the same.
    ...
    for r,d,f in os.walk(r"\\emcgis\nas\LUTOPS\GIS\Production\Transpor\GISbugUpdate_lyr_files"):
        InFCSouce= r+'\\'
        for item in f:
            if '.lyr' in item:
                InFCLayerName=item
