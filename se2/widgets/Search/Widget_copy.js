//////////////////////////////////////////////
//**** custom url paremters begin on line 61
//**** and end on 136
//////////////////////////////////////////////
...
/////////////////////////////////////////////////
// <!-- Add to new version of survey explorer starts -->.
///////////////////////////////////////////////////////////////
...
getAllUrlParams: function() {
  ...
  return obj; 
},      // <!-- Add to new version of survey explorer stops -->
        ...
        LayerInfos.getInstance(this.map, this.map.itemInfo)
          .then(lang.hitch(this, function(layerInfosObj) {
            ...
            when(utils.getConfigInfo(this.config)).then(lang.hitch(this, function(config) {
              ...
              // <!-- Add this line to new version of survey explorer start -->
              ...
              if (data['type'] && data['searchString']) {
                ...
                $.each(searchGroups, function() {
                    if (data['type'].toLowerCase() == $(this)[0].innerHTML.toLowerCase()){
                        $(this).click();
                        groupFound = 1;
                        return false;
                    }
              ...
              // <!-- Add this line to new version of survey explorer stops -->
