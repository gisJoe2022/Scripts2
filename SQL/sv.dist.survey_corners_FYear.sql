...
/****** Object:  View [survey].[SV_CORNERS__FYEAR]    Script Date: 3/23/2023 10:47:34 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [survey].[SV_CORNERS__FYEAR]
AS
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'survey', @level1type=N'VIEW',@level1name=N'SV_CORNERS__FYEAR'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'survey', @level1type=N'VIEW',@level1name=N'SV_CORNERS__FYEAR'
GO
