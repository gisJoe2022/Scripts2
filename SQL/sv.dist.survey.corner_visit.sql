...
SELECT  svcorn.Shape, svcorn.CORNER_ID, survey.V_Corners_FYear.CORNERID, svcorn.AltMon, survey.V_Corners_FYear.BT_Year, 
        survey.V_Corners_FYear.Visit_Year, survey.V_Corners_FYear.Final_Year, svcorn.OBJECTID
FROM    survey.CORNERS_evw0 AS svcorn INNER JOIN
           survey.V_Corners_FYear ON svcorn.CORNER_ID = survey.V_Corners_FYear.CORNERID

SELECT  svcorn.Shape, svcorn.CORNER_ID, survey.V_CORNER_VISITS.CORNERID, survey.V_CORNER_VISITS.TheDate, survey.V_CORNER_VISITS.Status, 
        ...
        survey.V_CORNER_VISITS.Note, svcorn.OBJECTID
