...
def update_fieldnotes1():
    ...
    arcpy.edit.Snap(
        in_features= prod + "\\production.SURVEY.corner_fieldnotes",
        snap_environment=[(prod + "\\production.SURVEY.CORNERS", "VERTEX", "20 Meters")]
    )
...
def gps_update1():
    ...
    arcpy.management.XYTableToPoint(
        in_table= prod + "\\production.survey.V_GPS",
        out_feature_class= prod + "\\production.SURVEY.corner_GPS",
        x_field="easting_f",
        y_field="northing_f",
        z_field=None,
